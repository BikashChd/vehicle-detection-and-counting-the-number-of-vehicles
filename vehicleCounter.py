...
# declaring minimum width rectangle
min_width_rectangle=80
# declaring minimum height rectangle
min_height_rectangle=80

# Initializing substactor algorithm
...
while True:
    ret,frame1=cap.read()
    # converting the video color into black and white
    grey=cv2.cvtColor(frame1,cv2.COLOR_BGR2GRAY)

    blur=cv2.GaussianBlur(grey,(3,3),5)

    # Now applying blur on each frame
    ...
    # drawing rectangle over the passing vehicle
